<template>
  <div class="footer">
    ...
    <ul>
      ...
      <li v-else><a href="https://www.data.gov.my/data/ms_MY/dataset/consumer-price-index-2010-100-index-number-for-main-groups-malaysia-annual">data.gov.my</a> (2005 - 2020)</li>
    </ul>
